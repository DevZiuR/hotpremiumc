        ...
        <div className="relative max-w-7xl xl:max-w-[1380px] mx-auto">
          ...
          <div className="rounded-[22px] border border-white/[0.08] bg-[#111113] p-1.5 sm:p-2">
            ...
            <Reveal delay={0} className="h-full">
              <div className="relative group overflow-hidden min-h-[200px] sm:min-h-[260px] lg:min-h-[320px] p-5 sm:p-7 md:p-8 flex flex-col justify-between bg-[#f4f5f7] rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-black/20 hover:z-10 h-full">
                ...
                <div className="relative z-10">
                  <p className="font-sans text-black text-[15px] sm:text-[16px] font-normal leading-[1.45] text-left drop-shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1.5 sm:gap-2">
            ...
            <Reveal delay={0} className="h-full">
              <div className="relative group overflow-hidden min-h-[200px] sm:min-h-[260px] lg:min-h-[320px] p-5 sm:p-7 md:p-8 flex flex-col justify-between bg-[#f4f5f7] md:bg-[#111113] rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-black/20 md:hover:shadow-black/50 hover:z-10 h-full">
                ...
                <div className="relative z-10">
                  <p className="font-sans text-black md:text-white text-[15px] sm:text-[16px] font-normal leading-[1.45] text-left drop-shadow-sm">
            ...
            <Reveal delay={90} className="h-full">
              <div className="relative group overflow-hidden min-h-[200px] sm:min-h-[260px] lg:min-h-[320px] p-5 sm:p-7 md:p-8 flex flex-col justify-between bg-[#111113] md:bg-[#f4f5f7] rounded-xl sm:rounded-2xl cursor-pointer transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-black/50 md:hover:shadow-black/20 hover:z-10 h-full">
                ...
                <div className="relative z-10">
                  <p className="font-sans text-white md:text-black text-[15px] sm:text-[16px] font-normal leading-[1.45] text-left drop-shadow-sm">
